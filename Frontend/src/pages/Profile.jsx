    ...
    <div style={{
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
          <div>
            <div style={{ display: 'inline-flex', alignItems: 'center', background: '#fff', padding: '6px 16px', borderRadius: '20px', fontSize: '14px', marginBottom: '16px', color: isDoctor ? '#166534' : '#c2185b' }}>
          ...
          <form onSubmit={handleSave} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '30px' }}>
            ...
            {isDoctor ? (
              <>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gridColumn: '1 / -1' }}>
                  ...
                  <textarea name="about" value={formData.about} onChange={handleChange} placeholder="Tell us about your background..." style={{...inputStyle, height: '100px'}} />
                </div>
              </>
            ) : (
              <>
            ...
            <div style={{ gridColumn: '1 / -1', display: 'flex', justifyContent: 'flex-end', marginTop: '20px' }}>
              <button type="submit" style={{
                background: isDoctor ? '#16a34a' : '#ff6b00', color: '#fff', border: 'none', padding: '14px 32px', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', fontSize: '16px', boxShadow: isDoctor ? '0 4px 10px rgba(22, 163, 74, 0.3)' : '0 4px 10px rgba(255,107,0,0.3)'
              }}>
                Save Profile
              </button>
            </div>
